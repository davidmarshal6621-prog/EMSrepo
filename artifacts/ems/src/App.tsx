...
function Router() {
  return (
    <Switch>
      ...
      <Route path="/employees"><ProtectedRoute component={EmployeesList} roles={ADMIN_HR_ROLES} /></Route>
      <Route path="/employees/new"><ProtectedRoute component={NewEmployee} roles={ADMIN_HR_ROLES} /></Route>
      <Route path="/employees/:id"><ProtectedRoute component={EmployeeProfile} roles={ADMIN_HR_ROLES} /></Route>
